# JSON Minifier & Compressor — Strip Whitespace Online

> Minify JSON payloads online for free. Strip whitespace, newlines, and indentation while verifying syntax and calculating compression metrics offline.

[![Live Web App](https://img.shields.io/badge/Web_App-Live_Demo-3B82F6?style=flat-square)](https://cig13zs.github.io/minify-json/)
[![Chrome Extension](https://img.shields.io/badge/Chrome_Extension-Manifest_V3-10B981?style=flat-square)](https://github.com/cig13zs/minify-json/releases)
...
- **Dual Delivery:** Use directly in your browser at [https://cig13zs.github.io/minify-json/](https://cig13zs.github.io/minify-json/) or install the offline Chrome Extension package.
...
Paste formatted JSON to remove all unnecessary whitespace and indentation, optimizing network payload size and storage.
...
1. Download or clone this repository:
   ```bash
   git clone https://github.com/cig13zs/minify-json.git
   ```
